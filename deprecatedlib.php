 ...
 */
function communityforum_count_unrated_posts() {
 ...
 */
function communityforum_tp_count_discussion_read_records() {
    throw new coding_exception(__FUNCTION__ . '() can not be used any more.');
}
 ...
 * @deprecated since Moodle 1.5 - please do not use this function any more.
 */
function communityforum_get_user_discussions() {
    throw new coding_exception(__FUNCTION__ . '() can not be used any more.');
}
 ...
 */
function communityforum_tp_count_communityforum_posts() {
    throw new coding_exception(__FUNCTION__ . '() can not be used any more.');
}
 ...
 * @deprecated since Moodle 1.6 - please do not use this function any more.
 */
function communityforum_tp_count_communityforum_read_records() {
    throw new coding_exception(__FUNCTION__ . '() can not be used any more.');
}
 ...
 */
function communityforum_get_open_modes() {
    throw new coding_exception(__FUNCTION__ . '() can not be used any more.');
}
 ...
 */
function communityforum_get_child_posts() {
    throw new coding_exception(__FUNCTION__ . '() can not be used any more.');
}
 ...
 * @deprecated since Moodle 1.9 MDL-13303 - please do not use this function any more.
 */
function communityforum_get_discussion_posts() {
    throw new coding_exception(__FUNCTION__ . '() can not be used any more.');
}
 ...
 */
function communityforum_get_ratings() {
    throw new coding_exception(__FUNCTION__ . '() can not be used any more.');
}
 ...
 */
function communityforum_get_tracking_link() {
    throw new coding_exception(__FUNCTION__ . '() can not be used any more.');
}
 ...
 */
function communityforum_tp_count_discussion_unread_posts() {
    throw new coding_exception(__FUNCTION__ . '() can not be used any more.');
}
 ...
 */
function communityforum_convert_to_roles() {
    throw new coding_exception(__FUNCTION__ . '() can not be used any more.');
}
 ...
 * @deprecated since Moodle 2.0 MDL-14113 - please do not use this function any more.
 */
function communityforum_tp_get_read_records() {
    throw new coding_exception(__FUNCTION__ . '() can not be used any more.');
}
 ...
 * @deprecated since Moodle 2.0 MDL-14113 - please do not use this function any more.
 */
function communityforum_tp_get_discussion_read_records() {
    throw new coding_exception(__FUNCTION__ . '() can not be used any more.');
}
 ...
 */
function communityforum_user_enrolled() {
    throw new coding_exception(__FUNCTION__ . '() can not be used any more.');
}
...
/**
 * @deprecated since Moodle 2.4 use communityforum_user_can_see_post() instead
 */
function communityforum_user_can_view_post() {
    throw new coding_exception(__FUNCTION__ . '() can not be used any more.');
}
...
/**
 * communityforum_TRACKING_ON - deprecated alias for communityforum_TRACKING_FORCED.
 * @deprecated since 2.6
 */
define('communityforum_TRACKING_ON', 2);

/**
 * @deprecated since Moodle 2.6
 * @see shorten_text()
 */
function communityforum_shorten_post($message) {
    throw new coding_exception(__FUNCTION__ . '() can not be used any more. '
        . 'Please use shorten_text($message, $CFG->communityforum_shortpost) instead.');
}
 ...
 */
function communityforum_is_subscribed() {
    throw new coding_exception(__FUNCTION__ . '() can not be used any more.');
}
 ...
 */
function communityforum_subscribe() {
 ...
 */
function communityforum_unsubscribe() {
    throw new coding_exception(__FUNCTION__ . '() can not be used any more. Please use '
 ...
 * @deprecated since Moodle 2.8 use \mod_forum\subscriptions::fetch_subscribed_users() instead
  */
function communityforum_subscribed_users() {
    throw new coding_exception(__FUNCTION__ . '() can not be used any more. Please use '
 ...
 */
function communityforum_is_forcesubscribed($forum) {
    throw new coding_exception(__FUNCTION__ . '() can not be used any more. Please use '
 ...
 */
function communityforum_forcesubscribe($forumid, $value = 1) {
    throw new coding_exception(__FUNCTION__ . '() can not be used any more. Please use '
 ...
 */
function communityforum_get_forcesubscribed($forum) {
    throw new coding_exception(__FUNCTION__ . '() can not be used any more. Please use '
        . \mod_forum\subscriptions::class . '::set_subscription_mode() instead');
}
 ...
 */
function communityforum_get_subscribed_forums() {
    throw new coding_exception(__FUNCTION__ . '() can not be used any more. Please use '
 ...
 */
function communityforum_get_optional_subscribed_forums() {
    throw new coding_exception(__FUNCTION__ . '() can not be used any more. Please use '
 ...
 */
function communityforum_get_potential_subscribers() {
    throw new coding_exception(__FUNCTION__ . '() can not be used any more. Please use '
 ...
 * @deprecated since Moodle 3.0 use \mod_forum\output\communityforum_post_email instead
 */
function communityforum_make_mail_text($course, $cm, $forum, $discussion, $post, $userfrom, $userto, $bare = false, $replyaddress = null) {
    global $PAGE;
    $renderable = new \mod_forum\output\communityforum_post_email(
        $course,
        $cm,
        $forum,
        $discussion,
        ...
        $userfrom,
        $userto,
        communityforum_user_can_post($forum, $discussion, $userto, $cm, $course)
        );
    ...
    debugging("communityforum_make_mail_text() has been deprecated, please use the \mod_forum\output\communityforum_post_email renderable instead.",
            DEBUG_DEVELOPER);
 ...
 * @deprecated since Moodle 3.0 use \mod_forum\output\communityforum_post_email instead
 */
function communityforum_make_mail_html($course, $cm, $forum, $discussion, $post, $userfrom, $userto, $replyaddress = null) {
    return communityforum_make_mail_post($course,
        $cm,
        $forum,
        $discussion,
        $post,
 ...
 * @deprecated since Moodle 3.0 use \mod_forum\output\communityforum_post_email instead
 */
function communityforum_make_mail_post($course, $cm, $forum, $discussion, $post, $userfrom, $userto,
    ...
    debugging("communityforum_make_mail_post() has been deprecated, please use the \mod_forum\output\communityforum_post_email renderable instead.",
            DEBUG_DEVELOPER);
