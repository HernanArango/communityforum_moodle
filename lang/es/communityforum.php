...
$string['error_delete_cateogry'] = 'Un error ha ocurrido al intentar eliminar la categoria.';
$string['error_edit_cateogry'] = 'Un error ha ocurrido al intentar editar la categoria.';
$string['add_category_correct'] = 'La categoria fue añadida correctamente.';
$string['settings_subscription'] = 'Opciones';
$string['readmore'] = 'leer mas';