...
$string['blockafter_help'] = 'This setting specifies the maximum number of posts which a user can post in the given time period. Users with the capability mod/communityforum:postwithoutthrottling are exempt from post limits.';
$string['blockperiod'] = 'Time period for blocking';
$string['blockperiod_help'] = 'Students can be blocked from posting more than a given number of posts in a given time period. Users with the capability mod/communityforum:postwithoutthrottling are exempt from post limits.';
...
$string['forum'] = 'Forum';
$string['communityforum:addinstance'] = 'Add a new forum';
$string['communityforum:addnews'] = 'Add announcements';
$string['communityforum:addquestion'] = 'Add question';
$string['communityforum:allowforcesubscribe'] = 'Allow force subscribe';
$string['communityforum:canoverridediscussionlock'] = 'Reply to locked discussions';
...
$string['communityforum:canposttomygroups'] = 'Can post to all groups you have access to';
$string['communityforum:createattachment'] = 'Create attachments';
$string['communityforum:deleteanypost'] = 'Delete any posts (anytime)';
$string['communityforum:deleteownpost'] = 'Delete own posts (within deadline)';
$string['communityforum:editanypost'] = 'Edit any post';
$string['communityforum:exportdiscussion'] = 'Export whole discussion';
$string['communityforum:exportownpost'] = 'Export own post';
$string['communityforum:exportpost'] = 'Export post';
$string['forumintro'] = 'Description';
$string['communityforum:managesubscriptions'] = 'Manage subscriptions';
$string['communityforum:movediscussions'] = 'Move discussions';
$string['communityforum:pindiscussions'] = 'Pin discussions';
$string['communityforum:postwithoutthrottling'] = 'Exempt from post threshold';
$string['forumname'] = 'Forum name';
$string['forumposts'] = 'Forum posts';
$string['communityforum:rate'] = 'Rate posts';
$string['communityforum:replynews'] = 'Reply to announcements';
$string['communityforum:replypost'] = 'Reply to posts';
$string['forums'] = 'Forums';
$string['communityforum:splitdiscussions'] = 'Split discussions';
$string['communityforum:startdiscussion'] = 'Start new discussions';
...
$string['communityforum:viewallratings'] = 'View all raw ratings given by individuals';
$string['communityforum:viewanyrating'] = 'View total ratings that anyone received';
$string['communityforum:viewdiscussion'] = 'View discussions';
$string['communityforum:viewhiddentimedposts'] = 'View hidden timed posts';
$string['communityforum:viewqandawithoutposting'] = 'Always see Q and A posts';
$string['communityforum:viewrating'] = 'View the total rating you received';
$string['communityforum:viewsubscribers'] = 'View subscribers';
...
$string['pluginname'] = 'Community Forum';
...
$string['unsubscribelink'] = 'Unsubscribe from this communityforum: {$a}';
...
$string['warnafter_help'] = 'Students can be warned as they approach the maximum number of posts allowed in a given period. This setting specifies after how many posts they are warned. Users with the capability mod/communityforum:postwithoutthrottling are exempt from post limits.';
