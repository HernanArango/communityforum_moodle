...
class mod_communityforum_mod_form extends moodleform_mod {
...
//-------------------------------------------------------------------------------
        ...
        $forumtypes = communityforum_get_forum_types();
        ...
        $options = array();
        $options[COMMUNITYFORUM_CHOOSESUBSCRIBE] = get_string('subscriptionoptional', 'forum');
        $options[COMMUNITYFORUM_FORCESUBSCRIBE] = get_string('subscriptionforced', 'forum');
        $options[COMMUNITYFORUM_INITIALSUBSCRIBE] = get_string('subscriptionauto', 'forum');
        $options[COMMUNITYFORUM_DISALLOWSUBSCRIBE] = get_string('subscriptiondisabled','forum');
        ...
        $options = array();
        $options[COMMUNITYFORUM_TRACKING_OPTIONAL] = get_string('trackingoptional', 'forum');
        $options[COMMUNITYFORUM_TRACKING_OFF] = get_string('trackingoff', 'forum');
        if ($CFG->forum_allowforcedreadtracking) {
            $options[COMMUNITYFORUM_TRACKING_FORCED] = get_string('trackingon', 'forum');
        }
        ...
        if ((!$CFG->forum_allowforcedreadtracking) && ($default == COMMUNITYFORUM_TRACKING_FORCED)) {
            $default = COMMUNITYFORUM_TRACKING_OPTIONAL;
        }
